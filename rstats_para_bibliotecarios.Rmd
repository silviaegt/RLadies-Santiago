...
### por Silvia Gutiérrez y Rodrigo Cuéllar


> ¡Hola! Este tutorial toma como base el taller de [Riva Quiroga](https://twitter.com/rivaquiroga) y el de Mariana Carmona/Godina. Su objetivo es acompañar a bibliotecarios que apenas empiezan en el mundo de la manipulación de datos apoyándonos en un ejercicio que tiene como base datos del trabajo concreto de su quehacer.

_________


## Seis preguntas para entender qué es R

### ¿Qué es R?
R: R es un lenguaje de programación estadístico. Facilita la manipulación de los datos, la simulación de eventos y la generación de gráficos, entre un sin fin de aplicaciones.
### ¿Qué es RStudio?
R: Aunque R lo puedes usar directo desde la terminal (es decir como que si pudieras hablar directo con la computadora); existe una interfaz (RStudio) que facilita muchísimo su uso y es por eso que vamos a aprender a usarla.
Estas interfaces se llaman IDEs, es decir, es una *Integrated Development Environment* (*Entorno de Desarrollo Integrado*).
###  ¿Qué son las cuatro ventanas que ves cuando abres RStudio?

![Consola de RStudio tomada de "20 funciones para perderle el miedo a R"](imagenes/consola.png "Consola de RStudio")


¿Por qué hay un hashtag antes de cada oración?
